...
Original file is located at
    https://colab.research.google.com/drive/1kMCa1BN_bXzL9WL5rk4hTv1UO_h_3qQ3
"""
...
if __name__ == '__main__':
    text_arr, tags_arr, labels = Reader.read('/content/joint-intent-classification-and-slot-filling-based-on-BERT/data/atis/test')
...
import pickle
if not os.path.exists('/content/drive/My Drive/NLU_MODEl_Context_atis'):
    os.makedirs('/content/drive/My Drive/NLU_MODEl_Context_atis')
    #print('Folder "%s" created' % save_folder_path)
#model.save('/content/drive/My Drive/NLU_MODEl_Context_atis')

with open(os.path.join('/content/drive/My Drive/NLU_MODEl_Context_atis', 'tags_vectorizer.pkl'), 'wb') as handle:
    pickle.dump(tags_vectorizer, handle, protocol=pickle.HIGHEST_PROTOCOL)
with open(os.path.join('/content/save/intents_label_encoder.pkl', 'intents_label_encoder.pkl'), 'wb') as handle:
    pickle.dump(intents_label_encoder, handle, protocol=pickle.HIGHEST_PROTOCOL)
...
model = JointBertModel.load(, sess)
...
with open(os.path.join('/content/drive/My Drive/NLU_MODEl_Context_atis', 'tags_vectorizer.pkl'), 'rb') as handle:
    tags_vectorizer = pickle.load(handle)
    slots_num = len(tags_vectorizer.label_encoder.classes_)
with open(os.path.join('/content/drive/My Drive/NLU_MODEl_Context_atis','intents_label_encoder.pkl'), 'rb') as handle:
...
with open(os.path.join('/content/drive/My Drive/NLU_MODEl_Context_atis', "eva_results.json"), 'w') as json_file:
    json.dump(eva_results, json_file)
